...
public class QuestionAdapter extends BaseAdapter {
    ...
    public QuestionAdapter(Context context, int layout, ArrayList<Question> data){
    ...
    @Override
    public String getItem(int position){return data.get(position).getContext();}
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(listviewitem.getStatus()!=null)
        {
            ...
            {
                name.setText(listviewitem.getNumber()+". "+listviewitem.getContext()+ " <completed question>");
            }
        }
