...
public class GETFinishedQuestionAPI {
    ...
    private void parsing(String result) throws JSONException {
        ...
        for(int i=0;i<size;i++)
        {
            ...
            if(upload.equals("upload"))
            {
                ...
                ArrayList<String> answerByStudent = new ArrayList<>();

                String str10 = JObject.getString("AnswerByStudent");
                Log.d("str",str2);

                JSONArray subArray10 = new JSONArray(str10);
                for(int j = 0; j < subArray10.length(); j++) {

                    String st = subArray9.get(j).toString();
                    Log.d("studentObject", st);
                    answerByStudent.add(st);
                }

                ArrayList<String> score = new ArrayList<>();

                String str11 = JObject.getString("score");
                Log.d("str",str2);

                JSONArray subArray11 = new JSONArray(str11);
                for(int j = 0; j < subArray11.length(); j++) {

                    String st = subArray11.get(j).toString();
                    Log.d("studentObject", st);
                    score.add(st);
                }
