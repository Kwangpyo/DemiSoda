...
public class GETQuestionAPITask {
...
//            parseJSON(json);
    ...
    private void parsing(String result) throws JSONException {
        ...
        for(int i=0;i<size;i++)
        {
            ...
            if(str2.equals("[]"))
            {
                Question q = new Question(Integer.valueOf(questionAmount),quizId,upload);
                questions.add(q);
            }
            ...
            else
            {
                ...
                {
                    Question q = new Question(questionType.get(a),Integer.valueOf(questionNumber.get(a)),questionStatus.get(a),questionContext.get(a),questionAnswer.get(a),quizId,lectureId,gradeSetting,answerContext1.get(a),answerContext2.get(a),answerContext3.get(a),answerContext4.get(a),Integer.valueOf(questionAmount),upload);
                    questions.add(q);
                }
